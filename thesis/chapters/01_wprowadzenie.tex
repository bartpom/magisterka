...
\begin{enumerate}
    ...
    \item Ocena skuteczności systemu przy użyciu standardowych metryk klasyfikacji binarnej: recall, FPR oraz analizy kompromisów na froncie Pareto.
\end{enumerate}
...
Uzyskane wyniki oraz zaproponowany benchmark mogą stanowić podstawę dalszego rozwinięcia pracy w kierunku publikacji naukowej dotyczącej heurystyczno-semantycznej detekcji materiałów wideo generowanych przez AI.
